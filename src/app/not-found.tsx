...
import { BTN_PRIMARY, GRAD, H1 } from '@/components/ui/document';
...
export default function NotFound() {
  return (
    <div className="grid min-h-svh place-items-center bg-canvas px-gutter text-center">
      <div>
        <span className="font-mono text-[.74rem] tracking-[.14em] uppercase text-ink-faint">
          Error 404
        </span>
        ...
        <p className="mx-auto mt-4 max-w-[34rem] text-ink-muted">
          The link may be out of date, or the address mistyped. Everything on the site is reachable
          from the home page.
        </p>
