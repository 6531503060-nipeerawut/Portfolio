...
import { CHANNELS, EMAIL, HEADINGS } from '@/constants/content';
import { CARD, GRAD, H2, REVEAL_SCALE, SECTION, SHELL } from '@/components/ui/document';
...
const CHANNEL_LABEL = 'block font-display text-[.95rem] font-semibold tracking-[-.01em] text-ink';
