...
import { HEADINGS, SKILL_GROUPS } from '@/constants/content';
import { CARD, GRAD, H2, H3, REVEAL, SECTION, SECTION_HEAD, SHELL } from '@/components/ui/document';
  ...
  return (
    <section className={SECTION} id="skills">
      <div className={SHELL}>
        ...
        {/*
          Four columns from 1280px up — the width at which SECTION starts
          demanding that a section fit one screen. auto-fit drops to three
          there and turns four groups into two rows, which is half a screen
          too tall. Below 1280px it reflows freely: the page scrolls there.
        */}
        <div className="grid gap-[clamp(1rem,2vw,1.35rem)] grid-cols-[repeat(auto-fit,minmax(min(255px,100%),1fr))] min-[1280px]:grid-cols-4">
