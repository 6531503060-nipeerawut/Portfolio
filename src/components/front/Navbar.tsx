...
export function Navbar() {
  return (
    <>
      <header
        className="nav fixed inset-x-0 top-0 z-[1100] border-b border-transparent py-[.85rem]
      ...
      >
        <div className="mx-auto flex w-full max-w-shell items-center justify-between gap-4 px-gutter">
          <Link
            ...
            href="/"
            aria-label="Peerawut Nipakornpan — home"
          >
            ...
            <span
              className="grid size-10 place-items-center rounded-[13px] bg-[image:var(--gradient-brand)]
                ...
                transition-[transform,background-position] duration-500 ease-spring
          ...
          >
            ...
            <span
              className="absolute top-[.3rem] left-0 h-[calc(100%-.6rem)] rounded-full opacity-0
                ...
                transition-[transform,width,opacity] duration-500 ease-brand
              ...
              <span className="relative grid size-[19px] place-items-center">
                <svg
                  className="absolute size-[19px] rotate-0 scale-100 opacity-100
                    transition-[opacity,transform] duration-[400ms] ease-spring
            ...
            >
              <span
                className="absolute top-[15px] left-1/2 -ml-[8.5px] h-[1.8px] w-[17px] rounded-sm bg-ink
                  transition-[transform,opacity,width] duration-[450ms] ease-spring
      ...
      <div
        className="drawer group invisible fixed inset-0 z-[1090] grid items-center justify-items-stretch
          ...
          {SECTIONS.map((section, index) => (
            <Link
              className="drawer__link flex translate-y-[18px] items-baseline gap-4 rounded-brand border
                ...
                text-ink opacity-0
                transition-[transform,opacity,background-color,border-color,color] duration-500 ease-brand
